package com.ironhack.inmoBarcelona.security;

import com.ironhack.inmoBarcelona.filters.CustomAuthenticationFilter;
import com.ironhack.inmoBarcelona.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                // Properties
                .requestMatchers(HttpMethod.GET,"/api/properties").hasAnyAuthority("ROLE_BUYER", "ROLE_SELLER", "ROLE_ADMIN")
                .requestMatchers(HttpMethod.POST,"/api/properties").hasAnyAuthority("ROLE_SELLER", "ROLE_ADMIN")
                .requestMatchers(HttpMethod.PUT,"/api/properties/{propertyId}").hasAnyAuthority("ROLE_SELLER", "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE,"/api/properties/{propertyId}").hasAnyAuthority("ROLE_SELLER", "ROLE_ADMIN")

                // Favorites
                .requestMatchers(HttpMethod.GET,"/api/favorites").authenticated()
                .requestMatchers(HttpMethod.POST,"/api/users/{userId}/favorites/{propertyId}").authenticated()
                .requestMatchers(HttpMethod.DELETE,"/api/favorites/{id}").authenticated()

                // Roles
                .requestMatchers(HttpMethod.POST,"/api/roles/addtouser").hasAnyAuthority("ROLE_ADMIN")
